...
export default function OrderTotals({order, tip, placeOrder}: OrderTotalsProps) {
   ...
   const totalAmout = useMemo(() => subTotalAmout + tipAmout, [tipAmout])
   ...
   return (
      <>
         <div className="space-y-3">
            ...
            <p>Propina {''} <span className="font-bold">{formatCurrency(tipAmout )}</span></p>
            <p>Total a Pagar {''} <span className="font-bold">{formatCurrency(totalAmout)}</span></p>
         </div>
